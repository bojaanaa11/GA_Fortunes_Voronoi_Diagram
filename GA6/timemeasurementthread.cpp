...
#include "./algoritmi_studentski_projekti/bojana_obradovic_fortune_voronoi.h"
...
void TimeMeasurementThread::run()
{
    ...
    for(int i= _minValue; i <= _maxValue; i += _step)
    {
        ...
        case TipAlgoritma::TRIANGULACIJA:
            ...
            break;
        case TipAlgoritma::FORTUNE:
            pAlgorithm = new Voronoi::FortuneVoronoi(nullptr, 0, false, "", i);
            break;
